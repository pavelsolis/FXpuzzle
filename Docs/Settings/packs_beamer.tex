...
\usepackage[style=authoryear,backend=biber,maxbibnames=99,maxcitenames=5,dashed=false]{biblatex} %Imports biblatex package
...
\definecolor{darkred}{rgb}{0.55, 0, 0}	% Good
